...
public:
    ...
    friend double distance_between( _SubwayPortal portal1,
                                    _SubwayPortal portal2);



    /** returns true if the two portals have the exact same set of routes  */
    friend bool same_routes( _SubwayPortal portal1,
                             _SubwayPortal portal2);

    /** returns true if the two portals belong to the same station */
    friend bool same_station( _SubwayPortal portal1,
                              _SubwayPortal portal2);

    friend ostream & operator<< ( ostream & out, _SubwayPortal e);
