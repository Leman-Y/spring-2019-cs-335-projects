...
bool Command::get_next (istream & in )
{
    ...
    if ( in.good() ) {
        ...
        if ( firstword.compare("list_route_stations") == 0 ) {
        ...
        } else if ( firstword.compare("list_all_stations") == 0 ) {
            this->type = list_all_stations_cmmd;

        } else if ( firstword.compare("list_station_portals") == 0  ) {
            getline(iss,rest_of_line);
            if ( !iss ) {
                std::cerr << line << ": ";
        ...
        else if (firstword.compare("list_routes") == 0 )  {
            getline(iss,rest_of_line);
            if ( !iss ) {
                std::cerr << line << ": ";
        ...
        else if ( firstword.compare("nearest_routes") == 0 ) {
        ...
        else if ( firstword.compare("nearest_portal") == 0 )  {
